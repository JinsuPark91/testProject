...
import { Checkbox, Button, TextArea } from 'teespace-core';
...
const SignupContent = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <CommonContent>
        <Checkbox shape="round" onChange={onCheckAllChange} checked={checkAll}>
          전체 약관에 동의합니다.
        </Checkbox>
        <InfoList>
          <InfoItem>
        ...
        >
          <Row>
            <Col span={24}>
              <Checkbox shape="round" value="agreeAge">
                (필수) 만 14세 이상입니다.
              </Checkbox>
            </Col>
            <Col span={24}>
              <Checkbox shape="round" value="agreeTerms">
                (필수) 서비스 이용약관 동의
              </Checkbox>
            </Col>
            <TextArea
...
부칙 본 약관은 2020년 6월 22일부터 적용됩니다"
            />
            <Col span={24}>
              <Checkbox shape="round" value="agreePersonal">
                (필수) 개인정보 수집 및 이용 동의
              </Checkbox>
            </Col>
            <TextArea
...
보유 및 이용기간 : 회원 탈퇴 후 5일 이내 혹은 개인정보의 수집 및 이용목적이 달성 이후 즉시 파기이용자는 상기 개인정보 수집 및 이용 동의를 거부할 권리가 있습니다. 다만, 동의 거부 시 회원 가입이 불가하여 회원 서비스를 이용하실 수 없습니다. 상세 내용은 개인정보처리방침을 참고 바랍니다."
            />
            <Col span={24}>
              <Checkbox shape="round" value="agreeAd">
